...
class JSONElementValueTests: XCTestCase {
    func testJSONElementValueInit() throws {
        ...
        let nullElement2 = try JSONElement(())
        ...
        XCTAssertEqual(nullElement2, JSONElement.null)
    ...
    func testJSONElementValueRepresentation() throws {
        ...
        let void: Void = JSONElement.null.value as! Void
        XCTAssertEqual(String(reflecting: void), "()")
